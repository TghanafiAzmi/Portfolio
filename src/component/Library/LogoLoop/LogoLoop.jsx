...
/** @typedef {{ src: string; alt?: string; href?: string; title?: string; ariaLabel?: string; width?: number; height?: number; srcSet?: string; sizes?: string; }} LogoImgItem */
/** @typedef {{ node: import('react').ReactNode; href?: string; title?: string; ariaLabel?: string; }} LogoNodeItem */
/** @typedef {LogoImgItem | LogoNodeItem} LogoItem */
 ...
 *  renderItem?: (item: LogoItem, key: string) => import('react').ReactNode;
 *  ariaLabel?: string;
 *  className?: string;
...
export const LogoLoop = memo(
  ...
  ({
    ...
    const isNodeItem = (item) => item && Object.prototype.hasOwnProperty.call(item, 'node');
