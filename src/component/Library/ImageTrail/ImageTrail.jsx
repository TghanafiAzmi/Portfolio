...
ImageTrail.propTypes = {
  items: PropTypes.arrayOf(PropTypes.string).isRequired,  // Ensures items is an array of strings (URLs)
  variant: PropTypes.number.isRequired,  // Ensures variant is a number
};
